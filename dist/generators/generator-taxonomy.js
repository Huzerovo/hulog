...
export default function (api) {
    ...
    const categoryPathToUrl = helper.get("categoryPathToUrl");
    const categoryPathToString = helper.get("categoryPathToString");
    api.plugins.generators.register("core:taxonomy", (site) => {
...
//# sourceMappingURL=generator-taxonomy.js.map