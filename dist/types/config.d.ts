...
/** themes 目录 */
export declare const THEME_BASE = "themes";
/** 插件目录 */
export declare const PLUGINS_BASE = "plugins";
/** 内容目录 */
export declare const CONTENT_BASE = "content";
/** 归档页 */
export declare const ARCHIVES_BASE = "archives";
/** 文章集合名 */
export declare const POSTS_NAME = "posts";
/** 草稿集合名 */
export declare const DRAFTS_NAME = "drafts";
/** 页面目录 */
export declare const PAGES_NAME = "pages";
/** 网站资源目录 */
export declare const ASSETS_BASE = "assets";
/** 其他资源 */
export declare const PUBLIC_BASE = "public";
